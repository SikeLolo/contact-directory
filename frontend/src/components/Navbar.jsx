  ...
  return (
    <div className=' relative w-full h-16 bg-[#b5c18e] border-black border-b-2'>
        ...
        <div className='h-full flex justify-end items-center gap-10 px-10 py-2 font-semibold font-sans text-xl'>
            ...
            {
              user ? (
                <Link to="/logout" className='rounded-md py-1 px-6 border-transparent border-2 select-none hover:bg-[#fef9d9] hover:border-stone-600 hover:shadow-md focus:outline-none focus:ring'>Logout</Link>
              ) : (
